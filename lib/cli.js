...
function init() {
  ...
  env.lookup(function () {
    ...
    //
    // [ ] ? Is .yo-rc.json is available
    // [ ] - yes: * require the file, get all available generators (top level
    ...
    // [ ]       - no: * build the generator string: [generator name]:args[0] and
    //                   prepend to args
    // [ ]             * run the generator with modified args
    // [ ] - no: Just run as usual
